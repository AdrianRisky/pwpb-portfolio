  ...
  <body>
         ...
         <div class="col-md-4 mb-5">
          <div class="card shadow-sm" style="width: 98%;">
            ...
            <div class="card-footer bg-light">
              <?php
              echo "<a class='btn btn-outline-danger me-1' style='width:48%;' onclick='add()'' name='simpan' href='formgallery.php?id=".$isi['id']."'>Edit</a> ";
              echo "<a class='btn btn-outline-primary ms-1' style='width:48%;' href='galleryhapus.php?id=".$isi['id']."'>Hapus</a>";
              ?>
            </div>
          </div>
         </div>
       ...
       <div class="container-fluid">
        <div class="card shadow mb-3 mt-3">
            <div class="card-body">
                ...
                <?php
                echo "<a class='btn btn-outline-primary ms-1' style='width:100%;' href='contacthapus.php?id=".$con['id']."'>Hapus</a>";
                ?>
            </div>
         </div>
        </div>
   ...
   <!-- Modal Input Gallery -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-header text-light" style="background-color: #ffd700">
